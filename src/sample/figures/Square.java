...
public enum Square {
    ...
    public Square getRightUpSquare() {
        return findBy(this.x + 1, this.y - 1);
    }

    public Square getLeftUpSquare() {
        return findBy(this.x - 1, this.y - 1);
    }

    public Square getRightDownSquare() {
        return findBy(this.x + 1, this.y + 1);
    }

    public Square getLeftDownSquare() {
        return findBy(this.x - 1, this.y + 1);
    }

    public static Square findBy(int x, int y) {
        Square result = null;
